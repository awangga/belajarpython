...
**Jika Ada yang Memakai Selenium (chrome) Pemakaian Selenium ChromeDriver**
1. browser harus mode **headless**
...
# Kuis Pemrograman Part 3
Kuis kali ini ada dua soal:
1. Kembangkan lagi **Class** dan **Method** kuis **kemaren**. Tambahkan lagi **10 method**, file harus berada dalam folder kelas masing-masing, dan harus menggunakan perintah **import**. **NB : LOGIKA, dan METHOD TIDAK BOLEH SAMA!!!**
2. Harus menggunakan librari CSV, database, matplotlib, dan requests.
2. instansiasi dan gunakan 10 method tersebut pada file main.py dengan inputan variabel yang dideklarasikan (bukan inputan user)

Jangka waktu pengerjaan dari:
Satu Minggu Sebelum Pertemuan Selanjutnya, perhari 2 method.
...
Penilaian sederhana, 1 method nilia 10. 
